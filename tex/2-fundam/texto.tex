...
A maior parte das ferramentas permite exportar figuras nesses formatos (a figura do exemplo foi produzida com o \emph{Inkscape}, um programa livre multiplataforma). A figura \ref{fig:exemplo1} mostra um exemplo de inclusão de figura em PDF.

% exemplo de inserção de figura (\source é obrigatório, \note é opcional}
\begin{figure}[!htb]
\centering
\caption{Comunicação inter-processos.}
\includegraphics[width=12cm]{exemplo-figura1.pdf}
\source{o próprio autor.}
\note{uma nota qualquer.}
\label{fig:exemplo1}
\end{figure}
...
\lstinputlisting{2-fundam/exemplo-codigo.c}
