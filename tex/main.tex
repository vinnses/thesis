...
% título
\title{Análise de tecnicas de modelos pequenos de linguagem em dominos farmaceuticos\\ (escrevi um título mais longo para ver como se comporta a quebra de linhas e o espaçamento entre elas)}
...
\pchave{Palavra-chave; palavra-chave; palavra-chave.}
